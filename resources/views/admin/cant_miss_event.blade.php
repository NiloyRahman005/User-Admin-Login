        ...
        <div class="col-lg-8 mx-auto">
            ...
            <div class="card">
                <div class="card-header">
                    <h3>Can't Miss This Event</h3>
                </div>

                <div class="card-body">


                    <form action="{{ route('admin.cant_miss_image') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        @if (isset($event->image))
                            <img src="{{ asset($event->image) }}" class="img-fluid" style="height:120px;width:150px;"
                                alt="">
                        @endif
                        <div class="mb-3">
